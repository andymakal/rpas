      ...
      <div className="flex-1 flex flex-col items-center justify-start px-4 py-8">
        <div className="w-full max-w-lg">
          <div className="mb-6">
            ...
            <p className="text-slate-500 mt-1 text-sm">Takes about 90 seconds. We'll take it from here.</p>
          </div>
          <div className="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
            <ReferralIntakeForm />
          </div>
          <p className="text-center text-xs text-slate-400 mt-6 px-4">
            All referrals are handled in accordance with Allstate Financial Services compliance guidelines.
